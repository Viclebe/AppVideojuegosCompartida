...
// Fondos
val FondoPantallaNegro = Color(0xFF000000)
val FondoContenedoresOscuro = Color(0xFF0A0A0A)
val FondoTarjetasGris = Color(0xFF121212)

// Colores neón
val AcentoNeonBlue = Color(0xFF007FFF)
